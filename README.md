...
This app was created to manually annotate a sample from the [ImgMT dataset](https://github.com/ufal/imgmt-devel) to estimate its quality. It supports annotating or post-editing pairs of SVGs with text that are supposed to be each other's translations. The annotation is stored in a JSON and contains all bounding boxes representing text fields, their text content, and alignment of the text fields between the SVGs.
